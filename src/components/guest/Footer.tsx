        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="https://www.facebook.com/cuseducation" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-[var(--text-secondary-700)] hover:bg-[var(--text-secondary-600)] flex items-center justify-center !text-white opacity-80 hover:opacity-100 transition" aria-label="Facebook">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/dgnl_with_cus?fbclid=IwY2xjawUKHeZwZG9mAWV4dG4DYWVtAjEwAGJyaWQRMXQ2czFzZlZ5dmZpYm5HcVNzcnRjBmFwcF9pZBAyMjIwMzkxNzg4MjAwODkyAAEehtITNNKM1FvAJcZCLooqM8PH_sPeO7ALjKtjIHV77Kx2_FrDjz7wNJ5gyPI_aem_6TGRBZjSzaNhZeNtdmdHLw" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-[var(--text-secondary-700)] hover:bg-[var(--text-secondary-600)] flex items-center justify-center !text-white opacity-80 hover:opacity-100 transition" aria-label="Instagram">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col gap-5 md:ml-4">
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li>
                <span className="!text-white opacity-80">V-ACT</span>
              </li>
              <li>
                <span className="!text-white opacity-80">V-SAT</span>
              </li>
              <li>
                <span className="!text-white opacity-80">HSA</span>
              </li>
              <li>
                <span className="!text-white opacity-80">HSCA</span>
              </li>
              <li>
                <span className="!text-white opacity-80">THPT QG</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <ul className="space-y-4 text-sm font-medium">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="https://www.cus.eud.vn" target="_blank" rel="noreferrer" className="!text-white opacity-80 hover:!text-white transition">
                  www.cus.edu.vn
                </a>
              </li>
              <li className="flex items-center gap-3 !text-white opacity-80">
