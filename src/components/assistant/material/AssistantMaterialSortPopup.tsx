        ...
        <div className="absolute right-0 top-[calc(100%+8px)] z-50 bg-white rounded-[12px] border border-[var(--border-default)] py-2 min-w-[200px] shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
          {SORT_OPTIONS.map((opt) => (
            <div
              ...
              className={`flex items-center gap-3 w-full px-4 py-2.5 bg-transparent border-none cursor-pointer font-[family-name:var(--font-heading)] font-semibold text-[13px] text-left transition-colors hover:bg-[var(--surface-500)] ${currentSort === opt.value ? 'text-[var(--brand-600)] bg-[var(--brand-50)] hover:bg-[var(--brand-50)]' : 'text-[var(--text-primary)]'
                }`}
            >
