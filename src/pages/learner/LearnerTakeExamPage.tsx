  ...
  if (submitted) {
    ...
    return (
      <div className="bg-[#F9FAFB] min-h-screen select-none flex flex-col">
        <Header />
        <div className="flex-grow flex flex-col items-center justify-center py-[60px] px-6 bg-[#F4F7F4]">
          <div className="bg-white rounded-[24px] shadow-[0_16px_48px_rgba(0,0,0,0.1)] pt-[56px] px-[48px] pb-[56px] text-center max-w-[480px] w-full">
            <div className="w-20 h-20 rounded-full bg-[#DCE9DE] flex items-center justify-center mx-auto mb-6">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none"><path d="M10 20l8 8 12-12" stroke="#2C5A31" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" /></svg>
            </div>
            ...
            <div className="bg-[#F4F7F4] rounded-[16px] px-6 py-5 mb-7">
              <div className="font-[family:var(--font-heading)] font-bold text-[42px] text-[#2C5A31]">{score}<span className="text-[20px] text-[#6B746D]">/10</span></div>
    ...
    <div className="bg-[#F9FAFB] min-h-screen select-none flex flex-col">
      ...
      <div className="max-w-[1200px] mx-auto pt-7 px-6 pb-20 grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-7 items-start flex-grow w-full">
        ...
        <div className="bg-white rounded-[20px] shadow-[0_2px_8px_rgba(0,0,0,0.05)] border border-[#E4EBE5] overflow-hidden">
          {/* Toolbar */}
          <div className="bg-[#F4F7F4] border-b border-[#E4EBE5] py-2.5 px-4 flex items-center justify-between gap-3">
          ...
          <div className="bg-[#6B746D] p-6 min-h-[700px] overflow-y-auto">
            <div className="bg-white max-w-[680px] mx-auto rounded-md pt-12 px-14 pb-12 shadow-[0_4px_20px_rgba(0,0,0,0.25)]">
              <div className="text-center mb-8 pb-6 border-b-2 border-[#1B1F1C]">
                ...
                <div className="font-[family:var(--font-heading)] font-bold text-lg text-[#1B1F1C]">ĐỀ THI THỬ THPT QUỐC GIA</div>
        ...
        <div className="sticky top-[84px] h-[calc(100vh-100px)]">
          <div className="bg-white rounded-[20px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-[#E4EBE5] overflow-hidden flex flex-col h-full">
            ...
            <div className="shrink-0 py-3.5 px-4 border-t border-[#E4EBE5]">
              ...
              <button onClick={() => navigate(ROUTES.LEARNER.EXAM_START(courseId, subjectId, examId))} className="w-full font-[family:var(--font-body)] text-[13px] py-2 mt-2 rounded-[12px] border-none bg-transparent text-[#6B746D] cursor-pointer transition-all duration-150 ease-out hover:bg-[#f4f7f4]">
                Thoát
              </button>
            </div>
          </div>
