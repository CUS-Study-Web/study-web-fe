...
const programsData = [
  {
    ...
    btnColor: "bg-[var(--brand-base-600)] hover:bg-[var(--brand-base-700)]"
  },
  {
    title: "V-SAT",
    ...
    btnColor: "bg-[var(--info-700)] hover:bg-[var(--info-800)]"
  },
  {
    title: "HSA",
    ...
    btnColor: "bg-[var(--warning-700)] hover:bg-[var(--warning-800)] text-white"
  },
  {
    title: "HSCA",
    ...
    btnColor: "bg-[#8b4181] hover:bg-[#72356a] text-white"
  },
  {
    title: "THPT QG",
    tag: "Bộ GD&ĐT",
    ...
    btnColor: "bg-[var(--info-800)] hover:bg-[var(--info-900)]"
  },
];
...
export default function CoursesPage() {
  return (
    <div className="pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 xl:px-20 mt-12 md:mt-16">
